...
const validateCreateCategory = ({ name, status }) => {
...
const validateImportCategoryRow = (row, rowNum) => {
...
module.exports = { validateCreateCategory, validateUpdateCategory, validateImportCategoryRow, caseInsensitiveNameRegex };
